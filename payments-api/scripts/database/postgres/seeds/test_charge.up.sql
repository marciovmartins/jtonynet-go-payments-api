-- Inserir em categories (independente)
...
-- Inserir em mccs (depende de categories)
...
-- Inserir em merchants (depende de mccs)
...
-- Inserir em transactions (depende de accounts e categories)
